    ...
    return (
      <div className="row margin-zero full-height">
        ...
        <div className="col m6 s12 responsive-half deep-orange darken-1">
          <div className="col s12 full-height pos-rel">
            <div className="login-contaier center-align">
              <a onClick={() => FirebaseUtil.signIn('customer', this.props.onAuthentication)} className="btn-floating grey lighten-5 btn-large pulse"><img className="responsive-img" src={GoogleIcon} /></a>
        ...
        <div className="col m6 s12 responsive-half lime darken-1">
          <div className="col s12 full-height pos-rel">
            <div className="login-contaier center-align">
              <a onClick={() => FirebaseUtil.signIn('store', this.props.onAuthentication)} className="btn-floating grey lighten-5 btn-large pulse"><img className="responsive-img" src={GoogleIcon} /></a>
